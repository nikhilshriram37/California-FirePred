...
export default function ControlPanel({
  counts, nCells, fireCount, showFires, generatedAt, visible, onToggleTier,
}: Props) {
      ...
      <div className="section">
        ...
        <div className="stat-grid">
          ...
          <div className="stat">
            ...
            <div className="k">active fires (🔥 overlay)</div>
          </div>
        </div>
        {showFires && (
          <>
            <div className="fire-legend">
              <span className="fire-dot" /> live NASA FIRMS detection · last 48h
            </div>
            <p className="legend-note" style={{ marginTop: 8 }}>
              <b>Observations</b> of fires happening now (satellite heat, 3 sensors),
              shown on top of the forecast. Can include hot industrial/agricultural
              sources, not only wildfires.
            </p>
          </>
        )}
      </div>
